...
HD_PWD='C:/Users/kmironp/Desktop/SimpleSoC-master/design/ArtySOC/ArtySOC.runs/design_1_axi_bram_ctrl_0_bram_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_bram_ctrl_0_bram_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_bram_ctrl_0_bram_3.tcl
