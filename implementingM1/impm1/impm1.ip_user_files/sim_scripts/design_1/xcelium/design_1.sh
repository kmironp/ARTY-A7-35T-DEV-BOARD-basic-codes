...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../impm1.gen/sources_1/bd/design_1/ipshared/3a46/rtl" \
       +incdir+"$ref_dir/../../../../impm1.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"$ref_dir/../../../../impm1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../impm1.gen/sources_1/bd/design_1/ipshared/3a46/rtl" \
       +incdir+"../../../../impm1.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../impm1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       -input simulate.do
}
